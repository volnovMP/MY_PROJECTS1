...
uses
  ...
  Dialogs, ComCtrls, Registry, ExtCtrls, StdCtrls, MMSystem, Buttons,
  Grids, ValEdit;
...
begin
  ...
  cbNot1.ItemIndex := FixNotify[1].Sound; if FixNotify[1].Enable then cbRunStop1.ItemIndex := 1 else cbRunStop1.ItemIndex := 0; cbViewObj1.ItemIndex := FixNotify[1].Obj;
  ...
  cbNot2.ItemIndex := FixNotify[2].Sound; if FixNotify[2].Enable then cbRunStop2.ItemIndex := 1 else cbRunStop2.ItemIndex := 0; cbViewObj2.ItemIndex := FixNotify[2].Obj;
