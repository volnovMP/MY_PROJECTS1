...
//    Редакция 5
//
//    Дата последней редакции 03 февраля 2006 года
//------------------------------------------------------------------------------
...
var
  ...
  ListNeisprav : string;      // список неисправностей и предупреждений для просмотра на резервном АРМе
  ...
  Lex : array[1..500] of TStringLex; // Список коротких сообщений РМ ДСП
  Lex2 : array[1..500] of TStringLex; // Список квитанций
  Lex3 : array[1..500] of TStringLex;

  LinkFR3 : array[1..4096] of TLinkFR3; // связка датчиков в канале
