...
begin
  ...
  begin
    if reg.ValueExists('left') then MsgFormDlg.Left := reg.ReadInteger('left') else MsgFormDlg.Left := 200;
    if reg.ValueExists('top') then MsgFormDlg.Top := reg.ReadInteger('top') else MsgFormDlg.Top := TabloMain.Height;
    if reg.ValueExists('height') then MsgFormDlg.Height := reg.ReadInteger('height') else MsgFormDlg.Height := Screen.Height- MsgFormDlg.Top;
    if reg.ValueExists('width') then MsgFormDlg.Width := reg.ReadInteger('width') else MsgFormDlg.Width := Screen.Width- MsgFormDlg.Left- 100;
    reg.CloseKey;
  end;
end;
